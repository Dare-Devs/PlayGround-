window.onload = function(){
	...
	//fix the if statement for square
	if (sWidth < 768) {
		...
		var createdTime; var clickedTime; var howSlow;  var highScore; var newHighScore;
		...
		function appear() {
			...
			var create = setTimeout(function() {
				...
				var t = Math.random();	t = 300 * t;

				var l = Math.random();	l = 380 * l;
